    ...
    return (
        <Container style={{ padding: "20px" }}>
            <div className="card-footer-container">
                <div className="footer-header mtg-font-bold">Banned Cards</div>
                <Card style={{ backgroundColor: "#232323", padding: "20px" }}>
                    ...
                    <ul>
                        <li className="banned-li"><a className="banned-a" href="https://scryfall.com/search?as=full&q=border%3Asilver" target="_blank" rel="noopener noreferrer" title="Link to Scryfall Results">All silver bordered cards from any of the “Un-” sets</a></li>
                        <li className="banned-li"><a className="banned-a" href="https://scryfall.com/search?as=grid&order=name&q=type%3Aconspiracy" target="_blank" rel="noopener noreferrer" title="Link to Scryfall Results">All (25) cards with the Card Type “Conspiracy”</a></li>
                        <li className="banned-li"><a className="banned-a" href="https://scryfall.com/search?as=grid&order=name&q=oracle%3A%22playing+for+ante%22" target="_blank" rel="noopener noreferrer" title="Link to Scryfall Results">All (9) cards that reference “playing for ante”</a></li>
                    </ul>
                    <ul>
                        {[
                        ...
                        <li className="banned-li"  key={cardinfo}>
                            <OverlayTrigger
                                key="right"
                                placement="right"
                                overlay={
                                    <Tooltip id={`tooltip-${cardinfo}`}>
                                        <span><img className="card-hover-image" alt="card" src={cardinfo.split("#")[1]}/></span>
                                    </Tooltip>
                                }
                                >
                                <a className="banned-a" href={cardinfo.split("#")[1]}  target="_blank" rel="noopener noreferrer">{cardinfo.split("#")[0]}</a>
                            </OverlayTrigger>
                        </li>
                    ))}
                    </ul>
