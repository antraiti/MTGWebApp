            ...
            <Row>
                <Card style={{ backgroundColor: "#232323", padding: "20px", marginBottom: "20px" }}>
                    ...
                    <ul>
                        ...
                        <li className="section-li">If you would like to use a companion alongside your Commander: Your companion is part of your deck’s sideboard, your deck must follow the deck building restrictions of the companion, and your companion must be in the same color identity as your commander.</li>
